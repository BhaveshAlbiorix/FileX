...
class FileIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (_extension == '.apk') {
      ...
      return Icon(FeatherIcons.download, color: Colors.lightBlue);
    } else if (_extension == '.zip' || _extension.contains('tar')) {
      return Icon(FeatherIcons.archive);
    } else if (_extension == '.epub' ||
        _extension == '.pdf' ||
        _extension == '.mobi') {
      return Icon(FeatherIcons.fileText, color: Colors.orangeAccent);
    } else {
      switch (type) {
        case 'image':
          return Container(
        ...
        case 'audio':
          return Icon(FeatherIcons.music, color: Colors.blue);
        case 'text':
          return Icon(FeatherIcons.fileText, color: Colors.orangeAccent);
        default:
          return Icon(FeatherIcons.file);
      }
    }
  }
}
